...
public class Helper {
    ...
    public void setText_HeadphoneState(Context c, TextView textView) {
        if (getHeadphonesState(c))
            textView.setText(R.string.s_headphoneOn);
        else
            textView.setText(R.string.s_headphoneOff);
    }

    public void setText_HeadphoneState(TextView textView, boolean isConnected) {
        if (isConnected)
            textView.setText(R.string.s_headphoneOn);
        else
            textView.setText(R.string.s_headphoneOff);
    ...
    public void setText_Charge(TextView textView1, TextView textView2, int chargeLevel, boolean isConnected) {
        String chargePercent = String.valueOf(chargeLevel) + R.string.s_percent;
        textView1.setText(chargePercent);
        if (isConnected)
            textView2.setText(R.string.s_chargeOn);
        else
            textView2.setText(R.string.s_chargeOff);
    }
